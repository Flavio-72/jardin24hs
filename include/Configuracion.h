...
#define PIN_DHT 18         // DHT22 Data (Seguro, evita TX0)
...
// --- Modos de Cultivo ---
enum ModoCultivo { CRECIMIENTO, FLORACION, PERSONALIZADO };
...
const PerfilCultivo PERFIL_VEGE_DEFAULT = {
    6, 0, 0, 0, 28.0, 70.0}; // 18hs luz (06:00-00:00)
const PerfilCultivo PERFIL_FLORA_DEFAULT = {
    7, 0, 19, 0, 26.0, 55.0}; // 12hs luz (07:00-19:00)
const PerfilCultivo PERFIL_PERS_DEFAULT = {
    8, 0, 20, 0, 27.0, 60.0}; // 12hs luz (08:00-20:00)
